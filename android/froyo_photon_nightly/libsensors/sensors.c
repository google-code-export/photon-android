...
/*#include <linux/akm8973.h> we do not have */
...
#define MAX_NUM_SENSORS 3 // was 6
...
/*    [ID_M] = SENSOR_TYPE_MAGNETIC_FIELD, we do not have (AKM8973)
    [ID_O] = SENSOR_TYPE_ORIENTATION, we do not have (AKM8973)
    [ID_T] = SENSOR_TYPE_TEMPERATURE, we do not have (AKM8973) */
...
const struct sensors_module_t HAL_MODULE_INFO_SYM = {
    .common = {
        ...
        .name = "BMA & CM3602 Sensors Module",
